...
static constexpr auto qt_meta_stringdata_ZN9PetWidgetE = QtMocHelpers::stringData(
    "PetWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9PetWidgetE[] = {
...
Q_CONSTINIT const QMetaObject PetWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9PetWidgetE.offsetsAndSizes,
    qt_meta_data_ZN9PetWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9PetWidgetE_t,
        // Q_OBJECT / Q_GADGET
...
void *PetWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9PetWidgetE.stringdata0))
